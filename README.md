...
| Role | Owner | Focus |
|---|---|---|
| **Notification & Platform Engineer** | [@Person A](#) | Reliable notification capture, foreground service, keeping the listener alive under aggressive OEM battery management (vivo/iQOO/Xiaomi/OnePlus) |
| **Rule Engine & UI Engineer** | [@Person B](#) | Rule/scoring logic for what counts as "important," and the Jetpack Compose UI that surfaces it |
